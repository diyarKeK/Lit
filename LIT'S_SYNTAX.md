...
Работать со строками проще не куда:
    ...
    fun main() {
        ...
        // Равенство и Неравенство строк через: == & !=
        print(s == 'Hello,World') // false
        print(s != 'Hello  , World!') // true


        // Возведение в вверхний и нижний регистры
...
В функциях где нужно возвращать:
    ...
    fun getIdByCase(str name): int {
        return switch name {
            'David' => 1,
            'Alex' => 2,
            default => 0 // Обязательно default при return
        }
    }
...
### 17. Дефолтные значения в функциях
...
просто укажите `this`, затем в 
скобках укажите аргументы, которые 
принимают класс:
...
На примере игры:
    ...
    class ParticleEntity : Entity {
        ...
        this(Particle particle, int time) {
...
не удобно, и долго.
Это всего лишь упрощенное представление
